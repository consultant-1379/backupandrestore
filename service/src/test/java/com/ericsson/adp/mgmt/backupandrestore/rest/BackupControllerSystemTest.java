...
public class BackupControllerSystemTest extends SystemTest {
    ...
    public void getBackupsForOneBackupManager_backupManagerId_getsAllBackupsForBackupManager() throws Exception {
        ...
        final ResponseEntity<BackupsResponse> responseEntity = restTemplate.getForEntity(getScopedBackupUrl(V1_BASE_URL, "backupManagerWithBackupToDelete"),
    ...
    public void getBackupsForOneBackupManager_inexistingBackupManagerId_notFound() throws Exception {
        final ResponseEntity<BackupsResponse> responseEntity = restTemplate.getForEntity(V1_BASE_URL + "backup-manager/qwe/backup",
                BackupsResponse.class);
    ...
    public void getOneBackupForOneBackupManager_backupManagerIdAndBackupId_getBackup() throws Exception {
        ...
        final ResponseEntity<BackupResponse> responseEntity = restTemplate
                .getForEntity(getScopedBackupUrl(V1_BASE_URL, "backupManagerWithBackupToDelete") + "/" + backupId, BackupResponse.class);
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
    ...
    public void getOneBackupForOneBackupManager_backupWasIncompleteWhenSystemStarted_backupIsCorrupted() throws Exception {
        final BackupResponse backup = restTemplate.getForObject(getScopedBackupUrl(V1_BASE_URL, "backupManagerWithBackupToDelete") + "/incompleteBackup", BackupResponse.class);
    ...
    @Test
    public void getOneBackupForOneBackupManager_inexistingBackupManagerId_notFound() throws Exception {
        final ResponseEntity<BackupResponse> responseEntity = restTemplate.getForEntity(V1_BASE_URL + "backup-manager/notFound/backup/notFound",
                BackupResponse.class);
    ...
    public void updateOneBackupForOneBackupManager_backupManagerIdAndBackupIdAndRequest_updatesBackup() throws Exception {
        ...
        final ResponseEntity<BackupResponse> responseEntity = restTemplate.getForEntity(getScopedBackupUrl(V1_BASE_URL, scope) + "/" + backupId, BackupResponse.class);
