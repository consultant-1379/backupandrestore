...
/**
 * External Client holds method to connect with Server
 */
public interface ExternalClient {

    /**
     * connect method connects with Server
     *
     * @param externalClientProperties
     *            externalClientProperties
     * @return ExternalConnection
     */
    ExternalConnection connect(final ExternalClientProperties externalClientProperties);
