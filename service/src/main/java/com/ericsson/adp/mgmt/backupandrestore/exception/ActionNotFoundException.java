...
/**
 * Represents failing to find a specific action.
 */
public class ActionNotFoundException extends NotFoundException {

    private static final long serialVersionUID = 3944322212100510386L;

    /**
     * Creates exception.
     * @param actionId id of action.
     */
    public ActionNotFoundException(final String actionId) {
