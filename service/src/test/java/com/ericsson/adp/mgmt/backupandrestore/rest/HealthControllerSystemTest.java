...
public class HealthControllerSystemTest extends SystemTestWithAgents {

    private static final Logger log = LogManager.getLogger(HealthControllerSystemTest.class);

    @Test
    public void getHealth_getRequest_getsHealth() throws Exception {
        final ResponseEntity<HealthResponse> responseEntity=
                restTemplate.getForEntity(V1_BASE_URL + "health", HealthResponse.class);
