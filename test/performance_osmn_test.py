#!/usr/bin/env python3
"""
This module runs daily performance tests for BRO with OSMN
"""
import os
import bro_ctrl
import bro_sftp
...
OSMN_SVC = BroS3()
OSMN_SETTINGS = OSMN_SVC.get_settings()
...
def test_deploy_osmn_server():
    ...
    OSMN_SVC.start_server(osmn_mode="distributed")
...
def test_rollback_via_helm_upgrade():
    ...
    helm3procs.helm_upgrade_with_chart_repo_with_dict(
        ...
        settings_dict={
            ...
            "osmn.host": OSMN_SETTINGS['endpoint'],
            "osmn.port": OSMN_SETTINGS['port'], },
        timeout=120)
...
# Export 5gb test case removed due to error that still has to be solved
...
# Import 5gb test case removed due to error "Handshake status 404 Not Found"
...
def test_export_1gb_backups():
    ...
    desc = "Export 5 backups, each 1GB"
    export_span = \
...
# Import 1gb test case removed due to error "Handshake status 404 Not Found"
