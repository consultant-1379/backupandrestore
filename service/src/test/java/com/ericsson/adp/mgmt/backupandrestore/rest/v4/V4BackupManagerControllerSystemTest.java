...
public class V4BackupManagerControllerSystemTest extends SystemTest {

    @Test
    public void getBackupManagers_noMatterWhatHasHappened_returnsListContainingDefaultBackupManager() throws Exception {
        final ResponseEntity<BackupManagersResponse> response = restTemplate.getForEntity(V4_BASE_URL + "backup-managers", BackupManagersResponse.class);
    ...
    public void getBackupManager_existingBackupManagerId_backupManager() throws Exception {
        final ResponseEntity<BackupManagerResponse> response = restTemplate.getForEntity(V4_BASE_URL + "backup-managers/DEFAULT", BackupManagerResponse.class);
    ...
    @Test
    public void getBackupManager_inexistentBackupManagerId_notFound() throws Exception {
        final ResponseEntity<ErrorResponse> response = restTemplate.getForEntity(V4_BASE_URL + "backup-managers/qqqqqqqqqqqqq", ErrorResponse.class);
    ...
    public void updateBackupManager_backupManagerIdAndRequest_noContentResponseAndBackupManagerIsUpdated() throws Exception {
        ...
        final BackupManagerResponse backupManager = restTemplate.getForObject(V4_BASE_URL + "backup-managers/DEFAULT", BackupManagerResponse.class);
